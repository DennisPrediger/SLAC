...
fn smart_vec(params: &Vec<Value>) -> &Vec<Value> {
    match params.get(0) {
...
pub fn abs(params: Vec<Value>) -> Result<Value, String> {
...
pub fn all(params: Vec<Value>) -> Result<Value, String> {
...
pub fn any(params: Vec<Value>) -> Result<Value, String> {
    let values = smart_vec(&params);
...
pub fn bool(params: Vec<Value>) -> Result<Value, String> {
    match params.first() {
...
pub fn contains(params: Vec<Value>) -> Result<Value, String> {
...
pub fn empty(params: Vec<Value>) -> Result<Value, String> {
    match params.first() {
...
pub fn float(params: Vec<Value>) -> Result<Value, String> {
    match params.first() {
        Some(value) => match value {
            Value::String(v) => {
...
pub fn int(params: Vec<Value>) -> Result<Value, String> {
...
pub fn length(params: Vec<Value>) -> Result<Value, String> {
    match params.first() {
...
pub fn lowercase(params: Vec<Value>) -> Result<Value, String> {
...
pub fn uppercase(params: Vec<Value>) -> Result<Value, String> {
    if let Some(Value::String(value)) = params.get(0) {
...
pub fn max(params: Vec<Value>) -> Result<Value, String> {
    smart_vec(&params)
        .iter()
        .max_by(|a, b| {
            if a < b {
...
pub fn min(params: Vec<Value>) -> Result<Value, String> {
    smart_vec(&params)
        .iter()
        .min_by(|a, b| {
            if a < b {
...
pub fn pow(params: Vec<Value>) -> Result<Value, String> {
...
pub fn round(params: Vec<Value>) -> Result<Value, String> {
    match params.first() {
...
pub fn str(params: Vec<Value>) -> Result<Value, String> {
